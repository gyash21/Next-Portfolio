...
export default function Home() {
  const career = [
    {
      title: "Egniol",
      description: 'Here, I spearheaded the web design and development execution for a dynamic team, working closely with the marketing, design, and product teams to ensure web appearance alignment with overall brand messaging.  ',
      time: "11 months",
      type: "Web Developer",
    ...
    {
      title: "Jyotirgamaya School",
      description: 'As an Assistant Professor, I taught English and Computer Science to students, focusing on bridging the learning gap caused by the COVID-19 pandemic. Understanding the challenges faced by students who missed a year of education, I provided extra attention and care, ensuring they received the support needed to regain their confidence and academic standing. ',
      time: "5 months",
