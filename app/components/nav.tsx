...
function NavItem({ href, text, icon 
    ...
    export default function Container(props: { children: any }) {
        ...
        const meta: any = {
          title: "Yash Gupta – developer, artist and storyteller",
          description: `I'm a frontend developer, artist and storyteller. I write about web development, design and productivity.`,
          image: "/avatar.png",
          type: "website",
          ...customMeta,
        };
